<?php 
    ...
    if (isset($_POST['submit'])) {
      ...
      if (empty($_POST['name']) || empty($_POST['code']) || empty($_POST['description'])) {
...
<div class="mb-3 mx-5 mt-3 " style="color: #BC8CE9; font-size: 20px; margin-top: -30px">
        ...
        <div class="mb-3 mx-5 mt-3 " style="color: #BC8CE9; font-size: 20px; margin-top: -30px">
          ...
          <input type="text" class="form-control  rounded-end" required id="code" style="background-color: rgba(0, 0, 0, 0.1); border-color: #B988E9; color:white" name="description">
        </div>
