        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex justify-content-end ms-auto  ">
                <button class="btn btn-info mt-5 ms-1" style="background-color: #8487C0; border-color: #8487C0;">
                    <a class="text-decoration-none text-white" href="./create.php">Add New User</a>
                </button>
            </div>

            <div class="d-flex justify-content-end ms-auto  ">
                <button class="btn btn-success mt-5 ms-1" style="background-color: #8487C0; border-color: #8487C0;">
                    <a class="text-decoration-none text-white" href="./export.php">Export</a>
                </button>
            </div>
